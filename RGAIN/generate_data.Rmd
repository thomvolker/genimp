...
rmse_loss <- function(ori_data, imputed_data, data_m, parameters = NULL){
...
rmse_letter <- rmse_loss(norms_letter, imputed_m_letter, mask_rmse_letter, parameters_letter)
...
# Calculate RMSE again
rmse_gen <- rmse_loss(norms_gen, imputed_data_gen, mask_rmse_gen, parameters_gen)
