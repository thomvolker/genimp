...
parameters_letter <- norm_$parameters  # parameters is a list, containing min_val and max
...
data_m_letter <- norms_letter * mask_letter
...
rmse_letter <- rmse_loss(norms_letter, imputed_m_letter, mask_rmse_letter)
...
parameters_gen <- norm_$parameters  # parameters is a list, containing min_val and max
...
# Calculate RMSE again
rmse_gen <- rmse_loss(norms_gen, imputed_data_gen, mask_rmse_gen)
print(paste("RMSE:", rmse))
```
