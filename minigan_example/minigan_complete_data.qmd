...
@sin-data shows the realized training data (orange points) and the conditional expectation $\mathbb{E}(x_2|x_1)$ true data generating distribution (black line). We can now train a GAN on this data generating distribution. We start by defining the generator and discriminator architectures.
